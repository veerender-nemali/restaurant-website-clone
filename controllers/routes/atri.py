...
class Atri:
	def __init__(self, state: Any):
		...
		self.logo_and_links = state["logo_and_links"]
		self.links = state["links"]
		self.Buttons = state["Buttons"]
		self.Info_and_burgerimage = state["Info_and_burgerimage"]
		self.Info_about_burger = state["Info_about_burger"]
		self.best_place_in_LA = state["best_place_in_LA"]
		self.first_div = state["first_div"]
		self.Div6 = state["Div6"]
		self.information_in_div = state["information_in_div"]
		self.buttons = state["buttons"]
		self.Burger_image = state["Burger_image"]
		self.Favorite_apps_section = state["Favorite_apps_section"]
		self.apps_info = state["apps_info"]
		self.apps = state["apps"]
		self.browse_our_menu = state["browse_our_menu"]
		self.browse_menu = state["browse_menu"]
		self.menu_items = state["menu_items"]
		self.breakfast = state["breakfast"]
		self.Div9 = state["Div9"]
		self.Div10 = state["Div10"]
		self.Div11 = state["Div11"]
		self.main_dishes = state["main_dishes"]
		...
		self.img_and_contact = state["img_and_contact"]
		self.come_and_visit_us_section = state["come_and_visit_us_section"]
		self.contact_titile = state["contact_titile"]
		self.address = state["address"]
		self.location_div = state["location_div"]
		self.Flex34 = state["Flex34"]
		self.Div24 = state["Div24"]
		self.Flex35 = state["Flex35"]
		self.Div25 = state["Div25"]
		self.aboutus_in_detail = state["aboutus_in_detail"]
		self.aboutus_first_para1 = state["aboutus_first_para1"]
		self.aboutus_btns = state["aboutus_btns"]
		self.snacks_section = state["snacks_section"]
		self.about_menu_div = state["about_menu_div"]
		self.snack_items = state["snack_items"]
		self.snacks_first_row = state["snacks_first_row"]
		self.item_1 = state["item_1"]
		self.Div41 = state["Div41"]
		self.Div42 = state["Div42"]
		self.item1_price = state["item1_price"]
		self.Div40 = state["Div40"]
		self.item_4 = state["item_4"]
		self.about_item4 = state["about_item4"]
		self.item4_name = state["item4_name"]
		self.item4_price = state["item4_price"]
		self.Div43 = state["Div43"]
		self.item_3 = state["item_3"]
		self.about_item3 = state["about_item3"]
		self.item3_name = state["item3_name"]
		self.item3_price = state["item3_price"]
		self.Div46 = state["Div46"]
		self.item_2 = state["item_2"]
		self.about_item2 = state["about_item2"]
		self.item2_name = state["item2_name"]
		self.item2_price = state["item2_price"]
		self.Div49 = state["Div49"]
		self.order_btns = state["order_btns"]
		self.snacks_second_row = state["snacks_second_row"]
		self.item_6 = state["item_6"]
		self.item6_price = state["item6_price"]
		self.Div52 = state["Div52"]
		self.item6_name = state["item6_name"]
		self.about_item6 = state["about_item6"]
		self.item_7 = state["item_7"]
		self.item7_price = state["item7_price"]
		self.Div53 = state["Div53"]
		self.item7_name = state["item7_name"]
		self.about_item7 = state["about_item7"]
		self.item_8 = state["item_8"]
		self.item8_price = state["item8_price"]
		self.Div54 = state["Div54"]
		self.item8_name = state["item8_name"]
		self.about_item8 = state["about_item8"]
		self.item_5 = state["item_5"]
		self.item5_price = state["item5_price"]
		self.Div55 = state["Div55"]
		self.item5_name = state["item5_name"]
		self.about_item5 = state["about_item5"]
		self.triple_burgerimg_and_about_it = state["triple_burgerimg_and_about_it"]
		self.burger_in_losangels = state["burger_in_losangels"]
		self.heading = state["heading"]
		self.something_about_it = state["something_about_it"]
		self.order_btnns = state["order_btnns"]
		self.triple_burger_img = state["triple_burger_img"]
		self.what_client_says = state["what_client_says"]
		self.number_of_cmts = state["number_of_cmts"]
		self.clients_says = state["clients_says"]
		self.about_what_client_says = state["about_what_client_says"]
		self.comments_section = state["comments_section"]
		self.left_arrow = state["left_arrow"]
		self.actual_comment_section = state["actual_comment_section"]
		self.stars = state["stars"]
		self.cmt_heading = state["cmt_heading"]
		self.cmt_about_burgers = state["cmt_about_burgers"]
		self.about_the_user = state["about_the_user"]
		self.user_details = state["user_details"]
		self.user_name = state["user_name"]
		self.user_place = state["user_place"]
		self.right_arrow = state["right_arrow"]
		self.orderbtns = state["orderbtns"]
		self.our_articles = state["our_articles"]
		self.title_and_links = state["title_and_links"]
		self.title_name = state["title_name"]
		self.browse_other_articles = state["browse_other_articles"]
		self.articles = state["articles"]
		self.article_1 = state["article_1"]
		self.article1_heading = state["article1_heading"]
		self.article1_date = state["article1_date"]
		self.about_article1 = state["about_article1"]
		self.four_articles = state["four_articles"]
		self.first_row = state["first_row"]
		self.article2 = state["article2"]
		self.article2_heading = state["article2_heading"]
		self.article2_date = state["article2_date"]
		self.article_3 = state["article_3"]
		self.article3_heading = state["article3_heading"]
		self.article3_date = state["article3_date"]
		self.second_row = state["second_row"]
		self.article_4 = state["article_4"]
		self.article4_heading = state["article4_heading"]
		self.article4_date = state["article4_date"]
		self.article_5 = state["article_5"]
		self.article5_heading = state["article5_heading"]
		self.article5_date = state["article5_date"]
		self.contact_and_book_your_table = state["contact_and_book_your_table"]
		self.book_your_table = state["book_your_table"]
		self.bookyourtable_title = state["bookyourtable_title"]
		self.res_email = state["res_email"]
		self.Div93 = state["Div93"]
		self.res_phono = state["res_phono"]
		self.Div94 = state["Div94"]
		self.res_address = state["res_address"]
		self.Div95 = state["Div95"]
		self.info_div = state["info_div"]
		self.contact_info = state["contact_info"]
		self.user_data = state["user_data"]
		self.row1 = state["row1"]
		self.user_name1 = state["user_name1"]
		self.Div98 = state["Div98"]
		self.user_email1 = state["user_email1"]
		self.Div103 = state["Div103"]
		self.row2 = state["row2"]
		self.user_location1 = state["user_location1"]
		self.Div104 = state["Div104"]
		self.user_phno1 = state["user_phno1"]
		self.Div105 = state["Div105"]
		self.row3 = state["row3"]
		self.user_schedule1 = state["user_schedule1"]
		self.Div106 = state["Div106"]
		self.user_date1 = state["user_date1"]
		self.Div107 = state["Div107"]
		self.row4 = state["row4"]
		self.add_a_note = state["add_a_note"]
		self.social_media = state["social_media"]
		self.insta_images = state["insta_images"]
		self.insta_imgs_2 = state["insta_imgs_2"]
		self.Flex129 = state["Flex129"]
		self.Flex130 = state["Flex130"]
		self.insta_link = state["insta_link"]
		self.follow_us_on_instagram = state["follow_us_on_instagram"]
		...
		self.restaurant_logo = state["restaurant_logo"]
		self.Home = state["Home"]
		self.About = state["About"]
		self.Menu = state["Menu"]
		self.Pages = state["Pages"]
		self.Cart = state["Cart"]
		self.Order_Online_btn = state["Order_Online_btn"]
		self.Reservate_btn = state["Reservate_btn"]
		self.Text1 = state["Text1"]
		self.Text2 = state["Text2"]
		self.TextBox3 = state["TextBox3"]
		self.reservate_btn = state["reservate_btn"]
		self.orderonline_btn = state["orderonline_btn"]
		self.burgerimg = state["burgerimg"]
		...
		self.Menu_text = state["Menu_text"]
		self.Breakfastimg = state["Breakfastimg"]
		self.Breakfast_text = state["Breakfast_text"]
		self.about_breakfast = state["about_breakfast"]
		self.explore_menu = state["explore_menu"]
		self.maindishesimg = state["maindishesimg"]
		self.TextBox9 = state["TextBox9"]
		self.TextBox10 = state["TextBox10"]
		self.maindishes_text = state["maindishes_text"]
		self.Image10 = state["Image10"]
		self.TextBox12 = state["TextBox12"]
		self.TextBox13 = state["TextBox13"]
		self.drinks_text = state["drinks_text"]
		self.Image11 = state["Image11"]
		self.TextBox15 = state["TextBox15"]
		self.TextBox16 = state["TextBox16"]
		self.TextBox17 = state["TextBox17"]
		self.order_online_btn = state["order_online_btn"]
		self.Book_a_table_button = state["Book_a_table_button"]
		self.aboutus_img = state["aboutus_img"]
		...
		self.aboutus_title = state["aboutus_title"]
		self.aboutus_second_para = state["aboutus_second_para"]
		self.aboutus_first_para_text = state["aboutus_first_para_text"]
		self.about_us_btn = state["about_us_btn"]
		self.join_our_team_btn = state["join_our_team_btn"]
		self.menu_text = state["menu_text"]
		self.about_menu_txt = state["about_menu_txt"]
		self.Image20 = state["Image20"]
		self.TextBox37 = state["TextBox37"]
		self.chicken_burger = state["chicken_burger"]
		self.TextBox36 = state["TextBox36"]
		self.pancake_img = state["pancake_img"]
		self.TextBox40 = state["TextBox40"]
		self.Pancakes = state["Pancakes"]
		self.TextBox39 = state["TextBox39"]
		self.classic_fries_img = state["classic_fries_img"]
		self.TextBox43 = state["TextBox43"]
		self.classic_fries = state["classic_fries"]
		self.TextBox42 = state["TextBox42"]
		self.chocolate_milkshake_img = state["chocolate_milkshake_img"]
		self.TextBox46 = state["TextBox46"]
		self.chocolate_milkshake = state["chocolate_milkshake"]
		self.TextBox45 = state["TextBox45"]
		self.Button15 = state["Button15"]
		self.Button16 = state["Button16"]
		self.chicken_burger_img = state["chicken_burger_img"]
		self.TextBox48 = state["TextBox48"]
		self.Chicken_Burger = state["Chicken_Burger"]
		self.TextBox53 = state["TextBox53"]
		self.Egg_toast_img = state["Egg_toast_img"]
		self.TextBox49 = state["TextBox49"]
		self.TextBox54 = state["TextBox54"]
		self.TextBox55 = state["TextBox55"]
		self.Regular_Soda_img = state["Regular_Soda_img"]
		...
		self.tripleburger_img = state["tripleburger_img"]
		...
		self.user_img = state["user_img"]
		self.TextBox67 = state["TextBox67"]
		self.TextBox68 = state["TextBox68"]
		self.Image30 = state["Image30"]
		self.bookatable_btn = state["bookatable_btn"]
		self.order_online_btn_ = state["order_online_btn_"]
		...
		self.user_button1 = state["user_button1"]
		...
		self.Img1 = state["Img1"]
		self.img2 = state["img2"]
		self.img3 = state["img3"]
		self.img4 = state["img4"]
		self.img6 = state["img6"]
		self.img5 = state["img5"]
		self.follow_us = state["follow_us"]
	...
	@property
	def logo_and_links(self):
		self._getter_access_tracker["logo_and_links"] = {}
		return self._logo_and_links
	@logo_and_links.setter
	def logo_and_links(self, new_state):
		self._setter_access_tracker["logo_and_links"] = {}
		global default_state
		self._logo_and_links = Flex(new_state, default_state["logo_and_links"])
	...
	@property
	def Info_and_burgerimage(self):
		self._getter_access_tracker["Info_and_burgerimage"] = {}
		return self._Info_and_burgerimage
	@Info_and_burgerimage.setter
	def Info_and_burgerimage(self, new_state):
		self._setter_access_tracker["Info_and_burgerimage"] = {}
		global default_state
		self._Info_and_burgerimage = Flex(new_state, default_state["Info_and_burgerimage"])

	@property
	def Info_about_burger(self):
		self._getter_access_tracker["Info_about_burger"] = {}
		return self._Info_about_burger
	@Info_about_burger.setter
	def Info_about_burger(self, new_state):
		self._setter_access_tracker["Info_about_burger"] = {}
		global default_state
		self._Info_about_burger = Flex(new_state, default_state["Info_about_burger"])

	@property
	def best_place_in_LA(self):
		self._getter_access_tracker["best_place_in_LA"] = {}
		return self._best_place_in_LA
	@best_place_in_LA.setter
	def best_place_in_LA(self, new_state):
		self._setter_access_tracker["best_place_in_LA"] = {}
		global default_state
		self._best_place_in_LA = Flex(new_state, default_state["best_place_in_LA"])

	@property
	def first_div(self):
		self._getter_access_tracker["first_div"] = {}
		return self._first_div
	@first_div.setter
	def first_div(self, new_state):
		self._setter_access_tracker["first_div"] = {}
		global default_state
		self._first_div = Div(new_state, default_state["first_div"])
	...
	@property
	def information_in_div(self):
		self._getter_access_tracker["information_in_div"] = {}
		return self._information_in_div
	@information_in_div.setter
	def information_in_div(self, new_state):
		self._setter_access_tracker["information_in_div"] = {}
		global default_state
		self._information_in_div = Div(new_state, default_state["information_in_div"])
	...
	def Burger_image(self, new_state):
		...
		global default_state
		self._Burger_image = Flex(new_state, default_state["Burger_image"])

	@property
	def Favorite_apps_section(self):
		self._getter_access_tracker["Favorite_apps_section"] = {}
		return self._Favorite_apps_section
	@Favorite_apps_section.setter
	def Favorite_apps_section(self, new_state):
		self._setter_access_tracker["Favorite_apps_section"] = {}
		global default_state
		self._Favorite_apps_section = Flex(new_state, default_state["Favorite_apps_section"])

	@property
	def apps_info(self):
		self._getter_access_tracker["apps_info"] = {}
		return self._apps_info
	@apps_info.setter
	def apps_info(self, new_state):
		self._setter_access_tracker["apps_info"] = {}
		global default_state
		self._apps_info = Div(new_state, default_state["apps_info"])
	...
	@property
	def browse_our_menu(self):
		self._getter_access_tracker["browse_our_menu"] = {}
		return self._browse_our_menu
	@browse_our_menu.setter
	def browse_our_menu(self, new_state):
		self._setter_access_tracker["browse_our_menu"] = {}
		global default_state
		self._browse_our_menu = Flex(new_state, default_state["browse_our_menu"])
	...
	def browse_menu(self, new_state):
		...
		global default_state
		self._browse_menu = Div(new_state, default_state["browse_menu"])

	@property
	def menu_items(self):
		self._getter_access_tracker["menu_items"] = {}
		return self._menu_items
	@menu_items.setter
	def menu_items(self, new_state):
		self._setter_access_tracker["menu_items"] = {}
		global default_state
		self._menu_items = Flex(new_state, default_state["menu_items"])
	...
	@property
	def main_dishes(self):
		self._getter_access_tracker["main_dishes"] = {}
		return self._main_dishes
	@main_dishes.setter
	def main_dishes(self, new_state):
		self._setter_access_tracker["main_dishes"] = {}
		global default_state
		self._main_dishes = Flex(new_state, default_state["main_dishes"])
	...
	@property
	def img_and_contact(self):
		self._getter_access_tracker["img_and_contact"] = {}
		return self._img_and_contact
	@img_and_contact.setter
	def img_and_contact(self, new_state):
		self._setter_access_tracker["img_and_contact"] = {}
		global default_state
		self._img_and_contact = Flex(new_state, default_state["img_and_contact"])

	@property
	def come_and_visit_us_section(self):
		self._getter_access_tracker["come_and_visit_us_section"] = {}
		return self._come_and_visit_us_section
	@come_and_visit_us_section.setter
	def come_and_visit_us_section(self, new_state):
		self._setter_access_tracker["come_and_visit_us_section"] = {}
		global default_state
		self._come_and_visit_us_section = Flex(new_state, default_state["come_and_visit_us_section"])

	@property
	def contact_titile(self):
		self._getter_access_tracker["contact_titile"] = {}
		return self._contact_titile
	@contact_titile.setter
	def contact_titile(self, new_state):
		self._setter_access_tracker["contact_titile"] = {}
		global default_state
		self._contact_titile = Div(new_state, default_state["contact_titile"])
	...
	def address(self, new_state):
		...
		global default_state
		self._address = Flex(new_state, default_state["address"])

	@property
	def location_div(self):
		self._getter_access_tracker["location_div"] = {}
		return self._location_div
	@location_div.setter
	def location_div(self, new_state):
		self._setter_access_tracker["location_div"] = {}
		global default_state
		self._location_div = Div(new_state, default_state["location_div"])
	...
	@property
	def aboutus_in_detail(self):
		self._getter_access_tracker["aboutus_in_detail"] = {}
		return self._aboutus_in_detail
	@aboutus_in_detail.setter
	def aboutus_in_detail(self, new_state):
		self._setter_access_tracker["aboutus_in_detail"] = {}
		global default_state
		self._aboutus_in_detail = Flex(new_state, default_state["aboutus_in_detail"])

	@property
	def aboutus_first_para1(self):
		self._getter_access_tracker["aboutus_first_para1"] = {}
		return self._aboutus_first_para1
	@aboutus_first_para1.setter
	def aboutus_first_para1(self, new_state):
		self._setter_access_tracker["aboutus_first_para1"] = {}
		global default_state
		self._aboutus_first_para1 = Div(new_state, default_state["aboutus_first_para1"])

	@property
	def aboutus_btns(self):
		self._getter_access_tracker["aboutus_btns"] = {}
		return self._aboutus_btns
	@aboutus_btns.setter
	def aboutus_btns(self, new_state):
		self._setter_access_tracker["aboutus_btns"] = {}
		global default_state
		self._aboutus_btns = Flex(new_state, default_state["aboutus_btns"])

	@property
	def snacks_section(self):
		self._getter_access_tracker["snacks_section"] = {}
		return self._snacks_section
	@snacks_section.setter
	def snacks_section(self, new_state):
		self._setter_access_tracker["snacks_section"] = {}
		global default_state
		self._snacks_section = Flex(new_state, default_state["snacks_section"])

	@property
	def about_menu_div(self):
		self._getter_access_tracker["about_menu_div"] = {}
		return self._about_menu_div
	@about_menu_div.setter
	def about_menu_div(self, new_state):
		self._setter_access_tracker["about_menu_div"] = {}
		global default_state
		self._about_menu_div = Div(new_state, default_state["about_menu_div"])

	@property
	def snack_items(self):
		self._getter_access_tracker["snack_items"] = {}
		return self._snack_items
	@snack_items.setter
	def snack_items(self, new_state):
		self._setter_access_tracker["snack_items"] = {}
		global default_state
		self._snack_items = Flex(new_state, default_state["snack_items"])

	@property
	def snacks_first_row(self):
		self._getter_access_tracker["snacks_first_row"] = {}
		return self._snacks_first_row
	@snacks_first_row.setter
	def snacks_first_row(self, new_state):
		self._setter_access_tracker["snacks_first_row"] = {}
		global default_state
		self._snacks_first_row = Flex(new_state, default_state["snacks_first_row"])

	@property
	def item_1(self):
		self._getter_access_tracker["item_1"] = {}
		return self._item_1
	@item_1.setter
	def item_1(self, new_state):
		self._setter_access_tracker["item_1"] = {}
		global default_state
		self._item_1 = Flex(new_state, default_state["item_1"])
	...
	@property
	def item1_price(self):
		self._getter_access_tracker["item1_price"] = {}
		return self._item1_price
	@item1_price.setter
	def item1_price(self, new_state):
		self._setter_access_tracker["item1_price"] = {}
		global default_state
		self._item1_price = Flex(new_state, default_state["item1_price"])
	...
	@property
	def item_4(self):
		self._getter_access_tracker["item_4"] = {}
		return self._item_4
	@item_4.setter
	def item_4(self, new_state):
		self._setter_access_tracker["item_4"] = {}
		global default_state
		self._item_4 = Flex(new_state, default_state["item_4"])

	@property
	def about_item4(self):
		self._getter_access_tracker["about_item4"] = {}
		return self._about_item4
	@about_item4.setter
	def about_item4(self, new_state):
		self._setter_access_tracker["about_item4"] = {}
		global default_state
		self._about_item4 = Div(new_state, default_state["about_item4"])

	@property
	def item4_name(self):
		self._getter_access_tracker["item4_name"] = {}
		return self._item4_name
	@item4_name.setter
	def item4_name(self, new_state):
		self._setter_access_tracker["item4_name"] = {}
		global default_state
		self._item4_name = Div(new_state, default_state["item4_name"])

	@property
	def item4_price(self):
		self._getter_access_tracker["item4_price"] = {}
		return self._item4_price
	@item4_price.setter
	def item4_price(self, new_state):
		self._setter_access_tracker["item4_price"] = {}
		global default_state
		self._item4_price = Flex(new_state, default_state["item4_price"])
	...
	@property
	def item_3(self):
		self._getter_access_tracker["item_3"] = {}
		return self._item_3
	@item_3.setter
	def item_3(self, new_state):
		self._setter_access_tracker["item_3"] = {}
		global default_state
		self._item_3 = Flex(new_state, default_state["item_3"])

	@property
	def about_item3(self):
		self._getter_access_tracker["about_item3"] = {}
		return self._about_item3
	@about_item3.setter
	def about_item3(self, new_state):
		self._setter_access_tracker["about_item3"] = {}
		global default_state
		self._about_item3 = Div(new_state, default_state["about_item3"])

	@property
	def item3_name(self):
		self._getter_access_tracker["item3_name"] = {}
		return self._item3_name
	@item3_name.setter
	def item3_name(self, new_state):
		self._setter_access_tracker["item3_name"] = {}
		global default_state
		self._item3_name = Div(new_state, default_state["item3_name"])

	@property
	def item3_price(self):
		self._getter_access_tracker["item3_price"] = {}
		return self._item3_price
	@item3_price.setter
	def item3_price(self, new_state):
		self._setter_access_tracker["item3_price"] = {}
		global default_state
		self._item3_price = Flex(new_state, default_state["item3_price"])
	...
	@property
	def item_2(self):
		self._getter_access_tracker["item_2"] = {}
		return self._item_2
	@item_2.setter
	def item_2(self, new_state):
		self._setter_access_tracker["item_2"] = {}
		global default_state
		self._item_2 = Flex(new_state, default_state["item_2"])

	@property
	def about_item2(self):
		self._getter_access_tracker["about_item2"] = {}
		return self._about_item2
	@about_item2.setter
	def about_item2(self, new_state):
		self._setter_access_tracker["about_item2"] = {}
		global default_state
		self._about_item2 = Div(new_state, default_state["about_item2"])

	@property
	def item2_name(self):
		self._getter_access_tracker["item2_name"] = {}
		return self._item2_name
	@item2_name.setter
	def item2_name(self, new_state):
		self._setter_access_tracker["item2_name"] = {}
		global default_state
		self._item2_name = Div(new_state, default_state["item2_name"])

	@property
	def item2_price(self):
		self._getter_access_tracker["item2_price"] = {}
		return self._item2_price
	@item2_price.setter
	def item2_price(self, new_state):
		self._setter_access_tracker["item2_price"] = {}
		global default_state
		self._item2_price = Flex(new_state, default_state["item2_price"])
	...
	@property
	def order_btns(self):
		self._getter_access_tracker["order_btns"] = {}
		return self._order_btns
	@order_btns.setter
	def order_btns(self, new_state):
		self._setter_access_tracker["order_btns"] = {}
		global default_state
		self._order_btns = Flex(new_state, default_state["order_btns"])

	@property
	def snacks_second_row(self):
		self._getter_access_tracker["snacks_second_row"] = {}
		return self._snacks_second_row
	@snacks_second_row.setter
	def snacks_second_row(self, new_state):
		self._setter_access_tracker["snacks_second_row"] = {}
		global default_state
		self._snacks_second_row = Flex(new_state, default_state["snacks_second_row"])

	@property
	def item_6(self):
		self._getter_access_tracker["item_6"] = {}
		return self._item_6
	@item_6.setter
	def item_6(self, new_state):
		self._setter_access_tracker["item_6"] = {}
		global default_state
		self._item_6 = Flex(new_state, default_state["item_6"])

	@property
	def item6_price(self):
		self._getter_access_tracker["item6_price"] = {}
		return self._item6_price
	@item6_price.setter
	def item6_price(self, new_state):
		self._setter_access_tracker["item6_price"] = {}
		global default_state
		self._item6_price = Flex(new_state, default_state["item6_price"])
	...
	@property
	def item6_name(self):
		self._getter_access_tracker["item6_name"] = {}
		return self._item6_name
	@item6_name.setter
	def item6_name(self, new_state):
		self._setter_access_tracker["item6_name"] = {}
		global default_state
		self._item6_name = Div(new_state, default_state["item6_name"])

	@property
	def about_item6(self):
		self._getter_access_tracker["about_item6"] = {}
		return self._about_item6
	@about_item6.setter
	def about_item6(self, new_state):
		self._setter_access_tracker["about_item6"] = {}
		global default_state
		self._about_item6 = Div(new_state, default_state["about_item6"])

	@property
	def item_7(self):
		self._getter_access_tracker["item_7"] = {}
		return self._item_7
	@item_7.setter
	def item_7(self, new_state):
		self._setter_access_tracker["item_7"] = {}
		global default_state
		self._item_7 = Flex(new_state, default_state["item_7"])

	@property
	def item7_price(self):
		self._getter_access_tracker["item7_price"] = {}
		return self._item7_price
	@item7_price.setter
	def item7_price(self, new_state):
		self._setter_access_tracker["item7_price"] = {}
		global default_state
		self._item7_price = Flex(new_state, default_state["item7_price"])
	...
	@property
	def item7_name(self):
		self._getter_access_tracker["item7_name"] = {}
		return self._item7_name
	@item7_name.setter
	def item7_name(self, new_state):
		self._setter_access_tracker["item7_name"] = {}
		global default_state
		self._item7_name = Div(new_state, default_state["item7_name"])

	@property
	def about_item7(self):
		self._getter_access_tracker["about_item7"] = {}
		return self._about_item7
	@about_item7.setter
	def about_item7(self, new_state):
		self._setter_access_tracker["about_item7"] = {}
		global default_state
		self._about_item7 = Div(new_state, default_state["about_item7"])

	@property
	def item_8(self):
		self._getter_access_tracker["item_8"] = {}
		return self._item_8
	@item_8.setter
	def item_8(self, new_state):
		self._setter_access_tracker["item_8"] = {}
		global default_state
		self._item_8 = Flex(new_state, default_state["item_8"])

	@property
	def item8_price(self):
		self._getter_access_tracker["item8_price"] = {}
		return self._item8_price
	@item8_price.setter
	def item8_price(self, new_state):
		self._setter_access_tracker["item8_price"] = {}
		global default_state
		self._item8_price = Flex(new_state, default_state["item8_price"])
	...
	@property
	def item8_name(self):
		self._getter_access_tracker["item8_name"] = {}
		return self._item8_name
	@item8_name.setter
	def item8_name(self, new_state):
		self._setter_access_tracker["item8_name"] = {}
		global default_state
		self._item8_name = Div(new_state, default_state["item8_name"])

	@property
	def about_item8(self):
		self._getter_access_tracker["about_item8"] = {}
		return self._about_item8
	@about_item8.setter
	def about_item8(self, new_state):
		self._setter_access_tracker["about_item8"] = {}
		global default_state
		self._about_item8 = Div(new_state, default_state["about_item8"])

	@property
	def item_5(self):
		self._getter_access_tracker["item_5"] = {}
		return self._item_5
	@item_5.setter
	def item_5(self, new_state):
		self._setter_access_tracker["item_5"] = {}
		global default_state
		self._item_5 = Flex(new_state, default_state["item_5"])

	@property
	def item5_price(self):
		self._getter_access_tracker["item5_price"] = {}
		return self._item5_price
	@item5_price.setter
	def item5_price(self, new_state):
		self._setter_access_tracker["item5_price"] = {}
		global default_state
		self._item5_price = Flex(new_state, default_state["item5_price"])
	...
	@property
	def item5_name(self):
		self._getter_access_tracker["item5_name"] = {}
		return self._item5_name
	@item5_name.setter
	def item5_name(self, new_state):
		self._setter_access_tracker["item5_name"] = {}
		global default_state
		self._item5_name = Div(new_state, default_state["item5_name"])

	@property
	def about_item5(self):
		self._getter_access_tracker["about_item5"] = {}
		return self._about_item5
	@about_item5.setter
	def about_item5(self, new_state):
		self._setter_access_tracker["about_item5"] = {}
		global default_state
		self._about_item5 = Div(new_state, default_state["about_item5"])

	@property
	def triple_burgerimg_and_about_it(self):
		self._getter_access_tracker["triple_burgerimg_and_about_it"] = {}
		return self._triple_burgerimg_and_about_it
	@triple_burgerimg_and_about_it.setter
	def triple_burgerimg_and_about_it(self, new_state):
		self._setter_access_tracker["triple_burgerimg_and_about_it"] = {}
		global default_state
		self._triple_burgerimg_and_about_it = Flex(new_state, default_state["triple_burgerimg_and_about_it"])

	@property
	def burger_in_losangels(self):
		self._getter_access_tracker["burger_in_losangels"] = {}
		return self._burger_in_losangels
	@burger_in_losangels.setter
	def burger_in_losangels(self, new_state):
		self._setter_access_tracker["burger_in_losangels"] = {}
		global default_state
		self._burger_in_losangels = Flex(new_state, default_state["burger_in_losangels"])
	...
	@property
	def something_about_it(self):
		self._getter_access_tracker["something_about_it"] = {}
		return self._something_about_it
	@something_about_it.setter
	def something_about_it(self, new_state):
		self._setter_access_tracker["something_about_it"] = {}
		global default_state
		self._something_about_it = Div(new_state, default_state["something_about_it"])

	@property
	def order_btnns(self):
		self._getter_access_tracker["order_btnns"] = {}
		return self._order_btnns
	@order_btnns.setter
	def order_btnns(self, new_state):
		self._setter_access_tracker["order_btnns"] = {}
		global default_state
		self._order_btnns = Flex(new_state, default_state["order_btnns"])

	@property
	def triple_burger_img(self):
		self._getter_access_tracker["triple_burger_img"] = {}
		return self._triple_burger_img
	@triple_burger_img.setter
	def triple_burger_img(self, new_state):
		self._setter_access_tracker["triple_burger_img"] = {}
		global default_state
		self._triple_burger_img = Flex(new_state, default_state["triple_burger_img"])

	@property
	def what_client_says(self):
		self._getter_access_tracker["what_client_says"] = {}
		return self._what_client_says
	@what_client_says.setter
	def what_client_says(self, new_state):
		self._setter_access_tracker["what_client_says"] = {}
		global default_state
		self._what_client_says = Flex(new_state, default_state["what_client_says"])

	@property
	def number_of_cmts(self):
		self._getter_access_tracker["number_of_cmts"] = {}
		return self._number_of_cmts
	@number_of_cmts.setter
	def number_of_cmts(self, new_state):
		self._setter_access_tracker["number_of_cmts"] = {}
		global default_state
		self._number_of_cmts = Flex(new_state, default_state["number_of_cmts"])

	@property
	def clients_says(self):
		self._getter_access_tracker["clients_says"] = {}
		return self._clients_says
	@clients_says.setter
	def clients_says(self, new_state):
		self._setter_access_tracker["clients_says"] = {}
		global default_state
		self._clients_says = Div(new_state, default_state["clients_says"])

	@property
	def about_what_client_says(self):
		self._getter_access_tracker["about_what_client_says"] = {}
		return self._about_what_client_says
	@about_what_client_says.setter
	def about_what_client_says(self, new_state):
		self._setter_access_tracker["about_what_client_says"] = {}
		global default_state
		self._about_what_client_says = Div(new_state, default_state["about_what_client_says"])

	@property
	def comments_section(self):
		self._getter_access_tracker["comments_section"] = {}
		return self._comments_section
	@comments_section.setter
	def comments_section(self, new_state):
		self._setter_access_tracker["comments_section"] = {}
		global default_state
		self._comments_section = Flex(new_state, default_state["comments_section"])
	...
	def left_arrow(self, new_state):
		...
		global default_state
		self._left_arrow = Flex(new_state, default_state["left_arrow"])

	@property
	def actual_comment_section(self):
		self._getter_access_tracker["actual_comment_section"] = {}
		return self._actual_comment_section
	@actual_comment_section.setter
	def actual_comment_section(self, new_state):
		self._setter_access_tracker["actual_comment_section"] = {}
		global default_state
		self._actual_comment_section = Flex(new_state, default_state["actual_comment_section"])

	@property
	def stars(self):
		self._getter_access_tracker["stars"] = {}
		return self._stars
	@stars.setter
	def stars(self, new_state):
		self._setter_access_tracker["stars"] = {}
		global default_state
		self._stars = Flex(new_state, default_state["stars"])

	@property
	def cmt_heading(self):
		self._getter_access_tracker["cmt_heading"] = {}
		return self._cmt_heading
	@cmt_heading.setter
	def cmt_heading(self, new_state):
		self._setter_access_tracker["cmt_heading"] = {}
		global default_state
		self._cmt_heading = Div(new_state, default_state["cmt_heading"])

	@property
	def cmt_about_burgers(self):
		self._getter_access_tracker["cmt_about_burgers"] = {}
		return self._cmt_about_burgers
	@cmt_about_burgers.setter
	def cmt_about_burgers(self, new_state):
		self._setter_access_tracker["cmt_about_burgers"] = {}
		global default_state
		self._cmt_about_burgers = Div(new_state, default_state["cmt_about_burgers"])

	@property
	def about_the_user(self):
		self._getter_access_tracker["about_the_user"] = {}
		return self._about_the_user
	@about_the_user.setter
	def about_the_user(self, new_state):
		self._setter_access_tracker["about_the_user"] = {}
		global default_state
		self._about_the_user = Flex(new_state, default_state["about_the_user"])

	@property
	def user_details(self):
		self._getter_access_tracker["user_details"] = {}
		return self._user_details
	@user_details.setter
	def user_details(self, new_state):
		self._setter_access_tracker["user_details"] = {}
		global default_state
		self._user_details = Flex(new_state, default_state["user_details"])

	@property
	def user_name(self):
		self._getter_access_tracker["user_name"] = {}
		return self._user_name
	@user_name.setter
	def user_name(self, new_state):
		self._setter_access_tracker["user_name"] = {}
		global default_state
		self._user_name = Div(new_state, default_state["user_name"])

	@property
	def user_place(self):
		self._getter_access_tracker["user_place"] = {}
		return self._user_place
	@user_place.setter
	def user_place(self, new_state):
		self._setter_access_tracker["user_place"] = {}
		global default_state
		self._user_place = Div(new_state, default_state["user_place"])
	...
	def right_arrow(self, new_state):
		...
		global default_state
		self._right_arrow = Flex(new_state, default_state["right_arrow"])

	@property
	def orderbtns(self):
		self._getter_access_tracker["orderbtns"] = {}
		return self._orderbtns
	@orderbtns.setter
	def orderbtns(self, new_state):
		self._setter_access_tracker["orderbtns"] = {}
		global default_state
		self._orderbtns = Flex(new_state, default_state["orderbtns"])

	@property
	def our_articles(self):
		self._getter_access_tracker["our_articles"] = {}
		return self._our_articles
	@our_articles.setter
	def our_articles(self, new_state):
		self._setter_access_tracker["our_articles"] = {}
		global default_state
		self._our_articles = Flex(new_state, default_state["our_articles"])

	@property
	def title_and_links(self):
		self._getter_access_tracker["title_and_links"] = {}
		return self._title_and_links
	@title_and_links.setter
	def title_and_links(self, new_state):
		self._setter_access_tracker["title_and_links"] = {}
		global default_state
		self._title_and_links = Flex(new_state, default_state["title_and_links"])

	@property
	def title_name(self):
		self._getter_access_tracker["title_name"] = {}
		return self._title_name
	@title_name.setter
	def title_name(self, new_state):
		self._setter_access_tracker["title_name"] = {}
		global default_state
		self._title_name = Div(new_state, default_state["title_name"])

	@property
	def browse_other_articles(self):
		self._getter_access_tracker["browse_other_articles"] = {}
		return self._browse_other_articles
	@browse_other_articles.setter
	def browse_other_articles(self, new_state):
		self._setter_access_tracker["browse_other_articles"] = {}
		global default_state
		self._browse_other_articles = Div(new_state, default_state["browse_other_articles"])
	...
	@property
	def article_1(self):
		self._getter_access_tracker["article_1"] = {}
		return self._article_1
	@article_1.setter
	def article_1(self, new_state):
		self._setter_access_tracker["article_1"] = {}
		global default_state
		self._article_1 = Flex(new_state, default_state["article_1"])

	@property
	def article1_heading(self):
		self._getter_access_tracker["article1_heading"] = {}
		return self._article1_heading
	@article1_heading.setter
	def article1_heading(self, new_state):
		self._setter_access_tracker["article1_heading"] = {}
		global default_state
		self._article1_heading = Div(new_state, default_state["article1_heading"])

	@property
	def article1_date(self):
		self._getter_access_tracker["article1_date"] = {}
		return self._article1_date
	@article1_date.setter
	def article1_date(self, new_state):
		self._setter_access_tracker["article1_date"] = {}
		global default_state
		self._article1_date = Div(new_state, default_state["article1_date"])

	@property
	def about_article1(self):
		self._getter_access_tracker["about_article1"] = {}
		return self._about_article1
	@about_article1.setter
	def about_article1(self, new_state):
		self._setter_access_tracker["about_article1"] = {}
		global default_state
		self._about_article1 = Div(new_state, default_state["about_article1"])

	@property
	def four_articles(self):
		self._getter_access_tracker["four_articles"] = {}
		return self._four_articles
	@four_articles.setter
	def four_articles(self, new_state):
		self._setter_access_tracker["four_articles"] = {}
		global default_state
		self._four_articles = Flex(new_state, default_state["four_articles"])

	@property
	def first_row(self):
		self._getter_access_tracker["first_row"] = {}
		return self._first_row
	@first_row.setter
	def first_row(self, new_state):
		self._setter_access_tracker["first_row"] = {}
		global default_state
		self._first_row = Flex(new_state, default_state["first_row"])

	@property
	def article2(self):
		self._getter_access_tracker["article2"] = {}
		return self._article2
	@article2.setter
	def article2(self, new_state):
		self._setter_access_tracker["article2"] = {}
		global default_state
		self._article2 = Flex(new_state, default_state["article2"])

	@property
	def article2_heading(self):
		self._getter_access_tracker["article2_heading"] = {}
		return self._article2_heading
	@article2_heading.setter
	def article2_heading(self, new_state):
		self._setter_access_tracker["article2_heading"] = {}
		global default_state
		self._article2_heading = Div(new_state, default_state["article2_heading"])

	@property
	def article2_date(self):
		self._getter_access_tracker["article2_date"] = {}
		return self._article2_date
	@article2_date.setter
	def article2_date(self, new_state):
		self._setter_access_tracker["article2_date"] = {}
		global default_state
		self._article2_date = Div(new_state, default_state["article2_date"])

	@property
	def article_3(self):
		self._getter_access_tracker["article_3"] = {}
		return self._article_3
	@article_3.setter
	def article_3(self, new_state):
		self._setter_access_tracker["article_3"] = {}
		global default_state
		self._article_3 = Flex(new_state, default_state["article_3"])

	@property
	def article3_heading(self):
		self._getter_access_tracker["article3_heading"] = {}
		return self._article3_heading
	@article3_heading.setter
	def article3_heading(self, new_state):
		self._setter_access_tracker["article3_heading"] = {}
		global default_state
		self._article3_heading = Div(new_state, default_state["article3_heading"])

	@property
	def article3_date(self):
		self._getter_access_tracker["article3_date"] = {}
		return self._article3_date
	@article3_date.setter
	def article3_date(self, new_state):
		self._setter_access_tracker["article3_date"] = {}
		global default_state
		self._article3_date = Div(new_state, default_state["article3_date"])

	@property
	def second_row(self):
		self._getter_access_tracker["second_row"] = {}
		return self._second_row
	@second_row.setter
	def second_row(self, new_state):
		self._setter_access_tracker["second_row"] = {}
		global default_state
		self._second_row = Flex(new_state, default_state["second_row"])

	@property
	def article_4(self):
		self._getter_access_tracker["article_4"] = {}
		return self._article_4
	@article_4.setter
	def article_4(self, new_state):
		self._setter_access_tracker["article_4"] = {}
		global default_state
		self._article_4 = Flex(new_state, default_state["article_4"])

	@property
	def article4_heading(self):
		self._getter_access_tracker["article4_heading"] = {}
		return self._article4_heading
	@article4_heading.setter
	def article4_heading(self, new_state):
		self._setter_access_tracker["article4_heading"] = {}
		global default_state
		self._article4_heading = Div(new_state, default_state["article4_heading"])

	@property
	def article4_date(self):
		self._getter_access_tracker["article4_date"] = {}
		return self._article4_date
	@article4_date.setter
	def article4_date(self, new_state):
		self._setter_access_tracker["article4_date"] = {}
		global default_state
		self._article4_date = Div(new_state, default_state["article4_date"])

	@property
	def article_5(self):
		self._getter_access_tracker["article_5"] = {}
		return self._article_5
	@article_5.setter
	def article_5(self, new_state):
		self._setter_access_tracker["article_5"] = {}
		global default_state
		self._article_5 = Flex(new_state, default_state["article_5"])

	@property
	def article5_heading(self):
		self._getter_access_tracker["article5_heading"] = {}
		return self._article5_heading
	@article5_heading.setter
	def article5_heading(self, new_state):
		self._setter_access_tracker["article5_heading"] = {}
		global default_state
		self._article5_heading = Div(new_state, default_state["article5_heading"])

	@property
	def article5_date(self):
		self._getter_access_tracker["article5_date"] = {}
		return self._article5_date
	@article5_date.setter
	def article5_date(self, new_state):
		self._setter_access_tracker["article5_date"] = {}
		global default_state
		self._article5_date = Div(new_state, default_state["article5_date"])

	@property
	def contact_and_book_your_table(self):
		self._getter_access_tracker["contact_and_book_your_table"] = {}
		return self._contact_and_book_your_table
	@contact_and_book_your_table.setter
	def contact_and_book_your_table(self, new_state):
		self._setter_access_tracker["contact_and_book_your_table"] = {}
		global default_state
		self._contact_and_book_your_table = Flex(new_state, default_state["contact_and_book_your_table"])

	@property
	def book_your_table(self):
		self._getter_access_tracker["book_your_table"] = {}
		return self._book_your_table
	@book_your_table.setter
	def book_your_table(self, new_state):
		self._setter_access_tracker["book_your_table"] = {}
		global default_state
		self._book_your_table = Flex(new_state, default_state["book_your_table"])

	@property
	def bookyourtable_title(self):
		self._getter_access_tracker["bookyourtable_title"] = {}
		return self._bookyourtable_title
	@bookyourtable_title.setter
	def bookyourtable_title(self, new_state):
		self._setter_access_tracker["bookyourtable_title"] = {}
		global default_state
		self._bookyourtable_title = Div(new_state, default_state["bookyourtable_title"])

	@property
	def res_email(self):
		self._getter_access_tracker["res_email"] = {}
		return self._res_email
	@res_email.setter
	def res_email(self, new_state):
		self._setter_access_tracker["res_email"] = {}
		global default_state
		self._res_email = Flex(new_state, default_state["res_email"])
	...
	@property
	def res_phono(self):
		self._getter_access_tracker["res_phono"] = {}
		return self._res_phono
	@res_phono.setter
	def res_phono(self, new_state):
		self._setter_access_tracker["res_phono"] = {}
		global default_state
		self._res_phono = Flex(new_state, default_state["res_phono"])
	...
	def res_address(self):
		self._getter_access_tracker["res_address"] = {}
		return self._res_address
	@res_address.setter
	def res_address(self, new_state):
		self._setter_access_tracker["res_address"] = {}
		global default_state
		self._res_address = Flex(new_state, default_state["res_address"])
	...
	@property
	def info_div(self):
		self._getter_access_tracker["info_div"] = {}
		return self._info_div
	@info_div.setter
	def info_div(self, new_state):
		self._setter_access_tracker["info_div"] = {}
		global default_state
		self._info_div = Div(new_state, default_state["info_div"])

	@property
	def contact_info(self):
		self._getter_access_tracker["contact_info"] = {}
		return self._contact_info
	@contact_info.setter
	def contact_info(self, new_state):
		self._setter_access_tracker["contact_info"] = {}
		global default_state
		self._contact_info = Flex(new_state, default_state["contact_info"])

	@property
	def user_data(self):
		self._getter_access_tracker["user_data"] = {}
		return self._user_data
	@user_data.setter
	def user_data(self, new_state):
		self._setter_access_tracker["user_data"] = {}
		global default_state
		self._user_data = Flex(new_state, default_state["user_data"])

	@property
	def row1(self):
		self._getter_access_tracker["row1"] = {}
		return self._row1
	@row1.setter
	def row1(self, new_state):
		self._setter_access_tracker["row1"] = {}
		global default_state
		self._row1 = Flex(new_state, default_state["row1"])

	@property
	def user_name1(self):
		self._getter_access_tracker["user_name1"] = {}
		return self._user_name1
	@user_name1.setter
	def user_name1(self, new_state):
		self._setter_access_tracker["user_name1"] = {}
		global default_state
		self._user_name1 = Flex(new_state, default_state["user_name1"])
	...
	@property
	def user_email1(self):
		self._getter_access_tracker["user_email1"] = {}
		return self._user_email1
	@user_email1.setter
	def user_email1(self, new_state):
		self._setter_access_tracker["user_email1"] = {}
		global default_state
		self._user_email1 = Flex(new_state, default_state["user_email1"])
	...
	@property
	def row2(self):
		self._getter_access_tracker["row2"] = {}
		return self._row2
	@row2.setter
	def row2(self, new_state):
		self._setter_access_tracker["row2"] = {}
		global default_state
		self._row2 = Flex(new_state, default_state["row2"])

	@property
	def user_location1(self):
		self._getter_access_tracker["user_location1"] = {}
		return self._user_location1
	@user_location1.setter
	def user_location1(self, new_state):
		self._setter_access_tracker["user_location1"] = {}
		global default_state
		self._user_location1 = Flex(new_state, default_state["user_location1"])
	...
	@property
	def user_phno1(self):
		self._getter_access_tracker["user_phno1"] = {}
		return self._user_phno1
	@user_phno1.setter
	def user_phno1(self, new_state):
		self._setter_access_tracker["user_phno1"] = {}
		global default_state
		self._user_phno1 = Flex(new_state, default_state["user_phno1"])
	...
	@property
	def row3(self):
		self._getter_access_tracker["row3"] = {}
		return self._row3
	@row3.setter
	def row3(self, new_state):
		self._setter_access_tracker["row3"] = {}
		global default_state
		self._row3 = Flex(new_state, default_state["row3"])

	@property
	def user_schedule1(self):
		self._getter_access_tracker["user_schedule1"] = {}
		return self._user_schedule1
	@user_schedule1.setter
	def user_schedule1(self, new_state):
		self._setter_access_tracker["user_schedule1"] = {}
		global default_state
		self._user_schedule1 = Flex(new_state, default_state["user_schedule1"])
	...
	@property
	def user_date1(self):
		self._getter_access_tracker["user_date1"] = {}
		return self._user_date1
	@user_date1.setter
	def user_date1(self, new_state):
		self._setter_access_tracker["user_date1"] = {}
		global default_state
		self._user_date1 = Flex(new_state, default_state["user_date1"])
	...
	@property
	def row4(self):
		self._getter_access_tracker["row4"] = {}
		return self._row4
	@row4.setter
	def row4(self, new_state):
		self._setter_access_tracker["row4"] = {}
		global default_state
		self._row4 = Flex(new_state, default_state["row4"])

	@property
	def add_a_note(self):
		self._getter_access_tracker["add_a_note"] = {}
		return self._add_a_note
	@add_a_note.setter
	def add_a_note(self, new_state):
		self._setter_access_tracker["add_a_note"] = {}
		global default_state
		self._add_a_note = Div(new_state, default_state["add_a_note"])

	@property
	def social_media(self):
		self._getter_access_tracker["social_media"] = {}
		return self._social_media
	@social_media.setter
	def social_media(self, new_state):
		self._setter_access_tracker["social_media"] = {}
		global default_state
		self._social_media = Flex(new_state, default_state["social_media"])

	@property
	def insta_images(self):
		self._getter_access_tracker["insta_images"] = {}
		return self._insta_images
	@insta_images.setter
	def insta_images(self, new_state):
		self._setter_access_tracker["insta_images"] = {}
		global default_state
		self._insta_images = Flex(new_state, default_state["insta_images"])

	@property
	def insta_imgs_2(self):
		self._getter_access_tracker["insta_imgs_2"] = {}
		return self._insta_imgs_2
	@insta_imgs_2.setter
	def insta_imgs_2(self, new_state):
		self._setter_access_tracker["insta_imgs_2"] = {}
		global default_state
		self._insta_imgs_2 = Flex(new_state, default_state["insta_imgs_2"])
	...
	@property
	def insta_link(self):
		self._getter_access_tracker["insta_link"] = {}
		return self._insta_link
	@insta_link.setter
	def insta_link(self, new_state):
		self._setter_access_tracker["insta_link"] = {}
		global default_state
		self._insta_link = Flex(new_state, default_state["insta_link"])

	@property
	def follow_us_on_instagram(self):
		self._getter_access_tracker["follow_us_on_instagram"] = {}
		return self._follow_us_on_instagram
	@follow_us_on_instagram.setter
	def follow_us_on_instagram(self, new_state):
		self._setter_access_tracker["follow_us_on_instagram"] = {}
		global default_state
		self._follow_us_on_instagram = Div(new_state, default_state["follow_us_on_instagram"])
	...
	def restaurant_logo(self):
		self._getter_access_tracker["restaurant_logo"] = {}
		return self._restaurant_logo
	@restaurant_logo.setter
	def restaurant_logo(self, new_state):
		self._setter_access_tracker["restaurant_logo"] = {}
		global default_state
		self._restaurant_logo = Image(new_state, default_state["restaurant_logo"])
	...
	def Home(self, new_state):
		...
		global default_state
		self._Home = Link(new_state, default_state["Home"])
	...
	def Menu(self, new_state):
		...
		global default_state
		self._Menu = Link(new_state, default_state["Menu"])
	...
	def Pages(self, new_state):
		...
		global default_state
		self._Pages = Link(new_state, default_state["Pages"])
	...
	def Cart(self, new_state):
		...
		global default_state
		self._Cart = Link(new_state, default_state["Cart"])

	@property
	def Order_Online_btn(self):
		self._getter_access_tracker["Order_Online_btn"] = {}
		return self._Order_Online_btn
	@Order_Online_btn.setter
	def Order_Online_btn(self, new_state):
		self._setter_access_tracker["Order_Online_btn"] = {}
		global default_state
		self._Order_Online_btn = Button(new_state, default_state["Order_Online_btn"])

	@property
	def Reservate_btn(self):
		self._getter_access_tracker["Reservate_btn"] = {}
		return self._Reservate_btn
	@Reservate_btn.setter
	def Reservate_btn(self, new_state):
		self._setter_access_tracker["Reservate_btn"] = {}
		global default_state
		self._Reservate_btn = Button(new_state, default_state["Reservate_btn"])
	...
	@property
	def orderonline_btn(self):
		self._getter_access_tracker["orderonline_btn"] = {}
		return self._orderonline_btn
	@orderonline_btn.setter
	def orderonline_btn(self, new_state):
		self._setter_access_tracker["orderonline_btn"] = {}
		global default_state
		self._orderonline_btn = Button(new_state, default_state["orderonline_btn"])

	@property
	def burgerimg(self):
		self._getter_access_tracker["burgerimg"] = {}
		return self._burgerimg
	@burgerimg.setter
	def burgerimg(self, new_state):
		self._setter_access_tracker["burgerimg"] = {}
		global default_state
		self._burgerimg = Image(new_state, default_state["burgerimg"])

	@property
	def TextBox(self):
		self._getter_access_tracker["TextBox"] = {}
		return self._TextBox
	@TextBox.setter
	def TextBox(self, new_state):
		self._setter_access_tracker["TextBox"] = {}
		global default_state
		self._TextBox = TextBox(new_state, default_state["TextBox"])
	...
	@property
	def Menu_text(self):
		self._getter_access_tracker["Menu_text"] = {}
		return self._Menu_text
	@Menu_text.setter
	def Menu_text(self, new_state):
		self._setter_access_tracker["Menu_text"] = {}
		global default_state
		self._Menu_text = TextBox(new_state, default_state["Menu_text"])

	@property
	def Breakfastimg(self):
		self._getter_access_tracker["Breakfastimg"] = {}
		return self._Breakfastimg
	@Breakfastimg.setter
	def Breakfastimg(self, new_state):
		self._setter_access_tracker["Breakfastimg"] = {}
		global default_state
		self._Breakfastimg = Image(new_state, default_state["Breakfastimg"])

	@property
	def Breakfast_text(self):
		self._getter_access_tracker["Breakfast_text"] = {}
		return self._Breakfast_text
	@Breakfast_text.setter
	def Breakfast_text(self, new_state):
		self._setter_access_tracker["Breakfast_text"] = {}
		global default_state
		self._Breakfast_text = TextBox(new_state, default_state["Breakfast_text"])

	@property
	def about_breakfast(self):
		self._getter_access_tracker["about_breakfast"] = {}
		return self._about_breakfast
	@about_breakfast.setter
	def about_breakfast(self, new_state):
		self._setter_access_tracker["about_breakfast"] = {}
		global default_state
		self._about_breakfast = TextBox(new_state, default_state["about_breakfast"])

	@property
	def explore_menu(self):
		self._getter_access_tracker["explore_menu"] = {}
		return self._explore_menu
	@explore_menu.setter
	def explore_menu(self, new_state):
		self._setter_access_tracker["explore_menu"] = {}
		global default_state
		self._explore_menu = TextBox(new_state, default_state["explore_menu"])

	@property
	def maindishesimg(self):
		self._getter_access_tracker["maindishesimg"] = {}
		return self._maindishesimg
	@maindishesimg.setter
	def maindishesimg(self, new_state):
		self._setter_access_tracker["maindishesimg"] = {}
		global default_state
		self._maindishesimg = Image(new_state, default_state["maindishesimg"])
	...
	@property
	def maindishes_text(self):
		self._getter_access_tracker["maindishes_text"] = {}
		return self._maindishes_text
	@maindishes_text.setter
	def maindishes_text(self, new_state):
		self._setter_access_tracker["maindishes_text"] = {}
		global default_state
		self._maindishes_text = TextBox(new_state, default_state["maindishes_text"])
	...
	def drinks_text(self):
		self._getter_access_tracker["drinks_text"] = {}
		return self._drinks_text
	@drinks_text.setter
	def drinks_text(self, new_state):
		self._setter_access_tracker["drinks_text"] = {}
		global default_state
		self._drinks_text = TextBox(new_state, default_state["drinks_text"])
	...
	@property
	def Book_a_table_button(self):
		self._getter_access_tracker["Book_a_table_button"] = {}
		return self._Book_a_table_button
	@Book_a_table_button.setter
	def Book_a_table_button(self, new_state):
		self._setter_access_tracker["Book_a_table_button"] = {}
		global default_state
		self._Book_a_table_button = Button(new_state, default_state["Book_a_table_button"])

	@property
	def aboutus_img(self):
		self._getter_access_tracker["aboutus_img"] = {}
		return self._aboutus_img
	@aboutus_img.setter
	def aboutus_img(self, new_state):
		self._setter_access_tracker["aboutus_img"] = {}
		global default_state
		self._aboutus_img = Image(new_state, default_state["aboutus_img"])
	...
	def text(self, new_state):
		...
		global default_state
		self._text = TextBox(new_state, default_state["text"])
	...
	def aboutus_title(self):
		self._getter_access_tracker["aboutus_title"] = {}
		return self._aboutus_title
	@aboutus_title.setter
	def aboutus_title(self, new_state):
		self._setter_access_tracker["aboutus_title"] = {}
		global default_state
		self._aboutus_title = TextBox(new_state, default_state["aboutus_title"])

	@property
	def aboutus_second_para(self):
		self._getter_access_tracker["aboutus_second_para"] = {}
		return self._aboutus_second_para
	@aboutus_second_para.setter
	def aboutus_second_para(self, new_state):
		self._setter_access_tracker["aboutus_second_para"] = {}
		global default_state
		self._aboutus_second_para = TextBox(new_state, default_state["aboutus_second_para"])

	@property
	def aboutus_first_para_text(self):
		self._getter_access_tracker["aboutus_first_para_text"] = {}
		return self._aboutus_first_para_text
	@aboutus_first_para_text.setter
	def aboutus_first_para_text(self, new_state):
		self._setter_access_tracker["aboutus_first_para_text"] = {}
		global default_state
		self._aboutus_first_para_text = TextBox(new_state, default_state["aboutus_first_para_text"])

	@property
	def about_us_btn(self):
		self._getter_access_tracker["about_us_btn"] = {}
		return self._about_us_btn
	@about_us_btn.setter
	def about_us_btn(self, new_state):
		self._setter_access_tracker["about_us_btn"] = {}
		global default_state
		self._about_us_btn = Button(new_state, default_state["about_us_btn"])

	@property
	def join_our_team_btn(self):
		self._getter_access_tracker["join_our_team_btn"] = {}
		return self._join_our_team_btn
	@join_our_team_btn.setter
	def join_our_team_btn(self, new_state):
		self._setter_access_tracker["join_our_team_btn"] = {}
		global default_state
		self._join_our_team_btn = Button(new_state, default_state["join_our_team_btn"])
	...
	@property
	def about_menu_txt(self):
		self._getter_access_tracker["about_menu_txt"] = {}
		return self._about_menu_txt
	@about_menu_txt.setter
	def about_menu_txt(self, new_state):
		self._setter_access_tracker["about_menu_txt"] = {}
		global default_state
		self._about_menu_txt = TextBox(new_state, default_state["about_menu_txt"])
	...
	def chicken_burger(self):
		self._getter_access_tracker["chicken_burger"] = {}
		return self._chicken_burger
	@chicken_burger.setter
	def chicken_burger(self, new_state):
		self._setter_access_tracker["chicken_burger"] = {}
		global default_state
		self._chicken_burger = TextBox(new_state, default_state["chicken_burger"])
	...
	@property
	def Pancakes(self):
		self._getter_access_tracker["Pancakes"] = {}
		return self._Pancakes
	@Pancakes.setter
	def Pancakes(self, new_state):
		self._setter_access_tracker["Pancakes"] = {}
		global default_state
		self._Pancakes = TextBox(new_state, default_state["Pancakes"])
	...
	@property
	def classic_fries_img(self):
		self._getter_access_tracker["classic_fries_img"] = {}
		return self._classic_fries_img
	@classic_fries_img.setter
	def classic_fries_img(self, new_state):
		self._setter_access_tracker["classic_fries_img"] = {}
		global default_state
		self._classic_fries_img = Image(new_state, default_state["classic_fries_img"])
	...
	def classic_fries(self, new_state):
		...
		global default_state
		self._classic_fries = TextBox(new_state, default_state["classic_fries"])
	...
	@property
	def chocolate_milkshake_img(self):
		self._getter_access_tracker["chocolate_milkshake_img"] = {}
		return self._chocolate_milkshake_img
	@chocolate_milkshake_img.setter
	def chocolate_milkshake_img(self, new_state):
		self._setter_access_tracker["chocolate_milkshake_img"] = {}
		global default_state
		self._chocolate_milkshake_img = Image(new_state, default_state["chocolate_milkshake_img"])
	...
	@property
	def chocolate_milkshake(self):
		self._getter_access_tracker["chocolate_milkshake"] = {}
		return self._chocolate_milkshake
	@chocolate_milkshake.setter
	def chocolate_milkshake(self, new_state):
		self._setter_access_tracker["chocolate_milkshake"] = {}
		global default_state
		self._chocolate_milkshake = TextBox(new_state, default_state["chocolate_milkshake"])
	...
	@property
	def chicken_burger_img(self):
		self._getter_access_tracker["chicken_burger_img"] = {}
		return self._chicken_burger_img
	@chicken_burger_img.setter
	def chicken_burger_img(self, new_state):
		self._setter_access_tracker["chicken_burger_img"] = {}
		global default_state
		self._chicken_burger_img = Image(new_state, default_state["chicken_burger_img"])
	...
	@property
	def Egg_toast_img(self):
		self._getter_access_tracker["Egg_toast_img"] = {}
		return self._Egg_toast_img
	@Egg_toast_img.setter
	def Egg_toast_img(self, new_state):
		self._setter_access_tracker["Egg_toast_img"] = {}
		global default_state
		self._Egg_toast_img = Image(new_state, default_state["Egg_toast_img"])
	...
	@property
	def Regular_Soda_img(self):
		self._getter_access_tracker["Regular_Soda_img"] = {}
		return self._Regular_Soda_img
	@Regular_Soda_img.setter
	def Regular_Soda_img(self, new_state):
		self._setter_access_tracker["Regular_Soda_img"] = {}
		global default_state
		self._Regular_Soda_img = Image(new_state, default_state["Regular_Soda_img"])
	...
	@property
	def tripleburger_img(self):
		self._getter_access_tracker["tripleburger_img"] = {}
		return self._tripleburger_img
	@tripleburger_img.setter
	def tripleburger_img(self, new_state):
		self._setter_access_tracker["tripleburger_img"] = {}
		global default_state
		self._tripleburger_img = Image(new_state, default_state["tripleburger_img"])
	...
	@property
	def user_img(self):
		self._getter_access_tracker["user_img"] = {}
		return self._user_img
	@user_img.setter
	def user_img(self, new_state):
		self._setter_access_tracker["user_img"] = {}
		global default_state
		self._user_img = Image(new_state, default_state["user_img"])
	...
	@property
	def bookatable_btn(self):
		self._getter_access_tracker["bookatable_btn"] = {}
		return self._bookatable_btn
	@bookatable_btn.setter
	def bookatable_btn(self, new_state):
		self._setter_access_tracker["bookatable_btn"] = {}
		global default_state
		self._bookatable_btn = Button(new_state, default_state["bookatable_btn"])

	@property
	def order_online_btn_(self):
		self._getter_access_tracker["order_online_btn_"] = {}
		return self._order_online_btn_
	@order_online_btn_.setter
	def order_online_btn_(self, new_state):
		self._setter_access_tracker["order_online_btn_"] = {}
		global default_state
		self._order_online_btn_ = Button(new_state, default_state["order_online_btn_"])
	...
	@property
	def image_2(self):
		self._getter_access_tracker["image_2"] = {}
		return self._image_2
	@image_2.setter
	def image_2(self, new_state):
		self._setter_access_tracker["image_2"] = {}
		global default_state
		self._image_2 = Image(new_state, default_state["image_2"])
	...
	@property
	def image_3(self):
		self._getter_access_tracker["image_3"] = {}
		return self._image_3
	@image_3.setter
	def image_3(self, new_state):
		self._setter_access_tracker["image_3"] = {}
		global default_state
		self._image_3 = Image(new_state, default_state["image_3"])
	...
	@property
	def image_4(self):
		self._getter_access_tracker["image_4"] = {}
		return self._image_4
	@image_4.setter
	def image_4(self, new_state):
		self._setter_access_tracker["image_4"] = {}
		global default_state
		self._image_4 = Image(new_state, default_state["image_4"])
	...
	@property
	def image_5(self):
		self._getter_access_tracker["image_5"] = {}
		return self._image_5
	@image_5.setter
	def image_5(self, new_state):
		self._setter_access_tracker["image_5"] = {}
		global default_state
		self._image_5 = Image(new_state, default_state["image_5"])
	...
	def user_button1(self):
		self._getter_access_tracker["user_button1"] = {}
		return self._user_button1
	@user_button1.setter
	def user_button1(self, new_state):
		self._setter_access_tracker["user_button1"] = {}
		global default_state
		self._user_button1 = Button(new_state, default_state["user_button1"])
	...
	@property
	def Img1(self):
		self._getter_access_tracker["Img1"] = {}
		return self._Img1
	@Img1.setter
	def Img1(self, new_state):
		self._setter_access_tracker["Img1"] = {}
		global default_state
		self._Img1 = Image(new_state, default_state["Img1"])

	@property
	def img2(self):
		self._getter_access_tracker["img2"] = {}
		return self._img2
	@img2.setter
	def img2(self, new_state):
		self._setter_access_tracker["img2"] = {}
		global default_state
		self._img2 = Image(new_state, default_state["img2"])

	@property
	def img3(self):
		self._getter_access_tracker["img3"] = {}
		return self._img3
	@img3.setter
	def img3(self, new_state):
		self._setter_access_tracker["img3"] = {}
		global default_state
		self._img3 = Image(new_state, default_state["img3"])

	@property
	def img4(self):
		self._getter_access_tracker["img4"] = {}
		return self._img4
	@img4.setter
	def img4(self, new_state):
		self._setter_access_tracker["img4"] = {}
		global default_state
		self._img4 = Image(new_state, default_state["img4"])

	@property
	def img6(self):
		self._getter_access_tracker["img6"] = {}
		return self._img6
	@img6.setter
	def img6(self, new_state):
		self._setter_access_tracker["img6"] = {}
		global default_state
		self._img6 = Image(new_state, default_state["img6"])

	@property
	def img5(self):
		self._getter_access_tracker["img5"] = {}
		return self._img5
	@img5.setter
	def img5(self, new_state):
		self._setter_access_tracker["img5"] = {}
		global default_state
		self._img5 = Image(new_state, default_state["img5"])

	@property
	def follow_us(self):
		self._getter_access_tracker["follow_us"] = {}
		return self._follow_us
	@follow_us.setter
	def follow_us(self, new_state):
		self._setter_access_tracker["follow_us"] = {}
		global default_state
		self._follow_us = Button(new_state, default_state["follow_us"])
	...
	def _to_json_fields(self):
		return {
			"Header": self._Header,
			"logo_and_links": self._logo_and_links,
			"links": self._links,
			"Buttons": self._Buttons,
			"Info_and_burgerimage": self._Info_and_burgerimage,
			"Info_about_burger": self._Info_about_burger,
			"best_place_in_LA": self._best_place_in_LA,
			"first_div": self._first_div,
			"Div6": self._Div6,
			"information_in_div": self._information_in_div,
			"buttons": self._buttons,
			"Burger_image": self._Burger_image,
			"Favorite_apps_section": self._Favorite_apps_section,
			"apps_info": self._apps_info,
			"apps": self._apps,
			"browse_our_menu": self._browse_our_menu,
			...
			"img_and_contact": self._img_and_contact,
			"come_and_visit_us_section": self._come_and_visit_us_section,
			"contact_titile": self._contact_titile,
			"address": self._address,
			"location_div": self._location_div,
			"Flex34": self._Flex34,
			"Div24": self._Div24,
			"Flex35": self._Flex35,
			"Div25": self._Div25,
			"aboutus_in_detail": self._aboutus_in_detail,
			"aboutus_first_para1": self._aboutus_first_para1,
			"aboutus_btns": self._aboutus_btns,
			"snacks_section": self._snacks_section,
			"about_menu_div": self._about_menu_div,
			"snack_items": self._snack_items,
			"snacks_first_row": self._snacks_first_row,
			"item_1": self._item_1,
			"Div41": self._Div41,
			"Div42": self._Div42,
			"item1_price": self._item1_price,
			"Div40": self._Div40,
			"item_4": self._item_4,
			"about_item4": self._about_item4,
			"item4_name": self._item4_name,
			"item4_price": self._item4_price,
			"Div43": self._Div43,
			"item_3": self._item_3,
			"about_item3": self._about_item3,
			"item3_name": self._item3_name,
			"item3_price": self._item3_price,
			"Div46": self._Div46,
			"item_2": self._item_2,
			"about_item2": self._about_item2,
			"item2_name": self._item2_name,
			"item2_price": self._item2_price,
			"Div49": self._Div49,
			"order_btns": self._order_btns,
			"snacks_second_row": self._snacks_second_row,
			"item_6": self._item_6,
			"item6_price": self._item6_price,
			"Div52": self._Div52,
			"item6_name": self._item6_name,
			"about_item6": self._about_item6,
			"item_7": self._item_7,
			"item7_price": self._item7_price,
			"Div53": self._Div53,
			"item7_name": self._item7_name,
			"about_item7": self._about_item7,
			"item_8": self._item_8,
			"item8_price": self._item8_price,
			"Div54": self._Div54,
			"item8_name": self._item8_name,
			"about_item8": self._about_item8,
			"item_5": self._item_5,
			"item5_price": self._item5_price,
			"Div55": self._Div55,
			"item5_name": self._item5_name,
			"about_item5": self._about_item5,
			"triple_burgerimg_and_about_it": self._triple_burgerimg_and_about_it,
			"burger_in_losangels": self._burger_in_losangels,
			"heading": self._heading,
			"something_about_it": self._something_about_it,
			"order_btnns": self._order_btnns,
			"triple_burger_img": self._triple_burger_img,
			"what_client_says": self._what_client_says,
			"number_of_cmts": self._number_of_cmts,
			"clients_says": self._clients_says,
			"about_what_client_says": self._about_what_client_says,
			"comments_section": self._comments_section,
			"left_arrow": self._left_arrow,
			"actual_comment_section": self._actual_comment_section,
			"stars": self._stars,
			"cmt_heading": self._cmt_heading,
			"cmt_about_burgers": self._cmt_about_burgers,
			"about_the_user": self._about_the_user,
			"user_details": self._user_details,
			"user_name": self._user_name,
			"user_place": self._user_place,
			"right_arrow": self._right_arrow,
			"orderbtns": self._orderbtns,
			"our_articles": self._our_articles,
			"title_and_links": self._title_and_links,
			"title_name": self._title_name,
			"browse_other_articles": self._browse_other_articles,
			"articles": self._articles,
			"article_1": self._article_1,
			"article1_heading": self._article1_heading,
			"article1_date": self._article1_date,
			"about_article1": self._about_article1,
			"four_articles": self._four_articles,
			"first_row": self._first_row,
			"article2": self._article2,
			"article2_heading": self._article2_heading,
			"article2_date": self._article2_date,
			"article_3": self._article_3,
			"article3_heading": self._article3_heading,
			"article3_date": self._article3_date,
			"second_row": self._second_row,
			"article_4": self._article_4,
			"article4_heading": self._article4_heading,
			"article4_date": self._article4_date,
			"article_5": self._article_5,
			"article5_heading": self._article5_heading,
			"article5_date": self._article5_date,
			"contact_and_book_your_table": self._contact_and_book_your_table,
			"book_your_table": self._book_your_table,
			"bookyourtable_title": self._bookyourtable_title,
			"res_email": self._res_email,
			"Div93": self._Div93,
			"res_phono": self._res_phono,
			"Div94": self._Div94,
			"res_address": self._res_address,
			"Div95": self._Div95,
			"info_div": self._info_div,
			"contact_info": self._contact_info,
			"user_data": self._user_data,
			"row1": self._row1,
			"user_name1": self._user_name1,
			"Div98": self._Div98,
			"user_email1": self._user_email1,
			"Div103": self._Div103,
			"row2": self._row2,
			"user_location1": self._user_location1,
			"Div104": self._Div104,
			"user_phno1": self._user_phno1,
			"Div105": self._Div105,
			"row3": self._row3,
			"user_schedule1": self._user_schedule1,
			"Div106": self._Div106,
			"user_date1": self._user_date1,
			"Div107": self._Div107,
			"row4": self._row4,
			"add_a_note": self._add_a_note,
			"social_media": self._social_media,
			"insta_images": self._insta_images,
			"insta_imgs_2": self._insta_imgs_2,
			"Flex129": self._Flex129,
			"Flex130": self._Flex130,
			"insta_link": self._insta_link,
			"follow_us_on_instagram": self._follow_us_on_instagram,
			...
			"Div134": self._Div134,
			"Div135": self._Div135,
			"restaurant_logo": self._restaurant_logo,
			"Home": self._Home,
			"About": self._About,
			"Menu": self._Menu,
			"Pages": self._Pages,
			"Cart": self._Cart,
			"Order_Online_btn": self._Order_Online_btn,
			"Reservate_btn": self._Reservate_btn,
			"Text1": self._Text1,
			"Text2": self._Text2,
			"TextBox3": self._TextBox3,
			"reservate_btn": self._reservate_btn,
			"orderonline_btn": self._orderonline_btn,
			"burgerimg": self._burgerimg,
			...
			"Breakfastimg": self._Breakfastimg,
			"Breakfast_text": self._Breakfast_text,
			"about_breakfast": self._about_breakfast,
			"explore_menu": self._explore_menu,
			"maindishesimg": self._maindishesimg,
			"TextBox9": self._TextBox9,
			"TextBox10": self._TextBox10,
			"maindishes_text": self._maindishes_text,
			"Image10": self._Image10,
			"TextBox12": self._TextBox12,
			"TextBox13": self._TextBox13,
			"drinks_text": self._drinks_text,
			"Image11": self._Image11,
			"TextBox15": self._TextBox15,
			"TextBox16": self._TextBox16,
			"TextBox17": self._TextBox17,
			"order_online_btn": self._order_online_btn,
			"Book_a_table_button": self._Book_a_table_button,
			"aboutus_img": self._aboutus_img,
			"text": self._text,
			...
			"aboutus_title": self._aboutus_title,
			"aboutus_second_para": self._aboutus_second_para,
			"aboutus_first_para_text": self._aboutus_first_para_text,
			"about_us_btn": self._about_us_btn,
			"join_our_team_btn": self._join_our_team_btn,
			"menu_text": self._menu_text,
			"about_menu_txt": self._about_menu_txt,
			"Image20": self._Image20,
			"TextBox37": self._TextBox37,
			"chicken_burger": self._chicken_burger,
			"TextBox36": self._TextBox36,
			"pancake_img": self._pancake_img,
			"TextBox40": self._TextBox40,
			"Pancakes": self._Pancakes,
			"TextBox39": self._TextBox39,
			"classic_fries_img": self._classic_fries_img,
			"TextBox43": self._TextBox43,
			"classic_fries": self._classic_fries,
			"TextBox42": self._TextBox42,
			"chocolate_milkshake_img": self._chocolate_milkshake_img,
			"TextBox46": self._TextBox46,
			"chocolate_milkshake": self._chocolate_milkshake,
			"TextBox45": self._TextBox45,
			"Button15": self._Button15,
			"Button16": self._Button16,
			"chicken_burger_img": self._chicken_burger_img,
			"TextBox48": self._TextBox48,
			"Chicken_Burger": self._Chicken_Burger,
			"TextBox53": self._TextBox53,
			"Egg_toast_img": self._Egg_toast_img,
			"TextBox49": self._TextBox49,
			"TextBox54": self._TextBox54,
			"TextBox55": self._TextBox55,
			"Regular_Soda_img": self._Regular_Soda_img,
			...
			"tripleburger_img": self._tripleburger_img,
			...
			"bookatable_btn": self._bookatable_btn,
			"order_online_btn_": self._order_online_btn_,
			...
			"user_button1": self._user_button1,
			"Input4": self._Input4,
